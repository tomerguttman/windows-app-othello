...
namespace UI
{
    public partial class BoardForm : Form
    {
        ...
        public BoardForm(int i_NumberOfPlayers, int i_BoardSize)
        {
            m_AmountOfPlayersPlaying = i_NumberOfPlayers;
            m_OthelloBoard = new GameData.OthelloBoard(i_BoardSize);
        ...
        private void InitializeComponent(int i_BoardSize)
        {
            ...
            {
                case 6:
                    InitializeComponent6x6();
                    break;

                case 8:
                    InitializeComponent8x8();
                    break;

                case 10:
                    InitializeComponent10x10();
                    break;

                case 12:
                    InitializeComponent12x12();
                    break;
            }
        }
        ...
        private OthelloPlayer GetCurrentPlayer(char i_CurrentPlayerColor)
        {
